...
> **Note:** The **Express `server/`** tree is not in this repo anymore (frontend-only snapshot). Diagrams below describe the original target architecture if you reintroduce a backend.
