...
> **Note:** There is no bundled Express app in this repo. Calls to `/api/*` from provider workspace pages need your own API host (e.g. set `VITE_API_URL`) or they will fail at runtime.
